...
object TempMessageStore {
    ...
    private fun getInitialMessages(chatId: String): List<TempChatMessage> {
        ...
        return listOf(
            ...
            TempChatMessage("3", "I have a question about the assignment", "10:32 AM", true, MessageStatus.READ),
            TempChatMessage("4", "Sure, what would you like to know?", "10:33 AM", false),
            TempChatMessage("5", "When is the submission deadline?", "10:34 AM", true, MessageStatus.DELIVERED)
